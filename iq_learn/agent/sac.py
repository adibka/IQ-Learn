...
from agent.sac_models import DiagGaussianActor, SingleQCritic
...
class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args):
        ...
        self.critic = SingleQCritic(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.critic_cfg.hidden_dim, 
                                                    agent_cfg.critic_cfg.hidden_depth, args=args).to(self.device)
        self.critic_target = SingleQCritic(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.critic_cfg.hidden_dim, 
                                                    agent_cfg.critic_cfg.hidden_depth, args=args).to(self.device)
        self.critic_target.load_state_dict(self.critic.state_dict())

        self.actor = DiagGaussianActor(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.actor_cfg.hidden_dim, 
                                                    agent_cfg.actor_cfg.hidden_depth, agent_cfg.actor_cfg.log_std_bounds).to(self.device)
